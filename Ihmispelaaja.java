class Ihmispelaaja implements Pelaaja {
	...
	public void liikuttaa(Pelilauta pelilauta){
		if (Tuomari.onkoVaihe(0)){
			...
			int uusiSijaintiNo =	Ruutu.valittu.getX();  	/*pelaajan valitsema uusi sijainti sallitutSiirroista*/;
			int uusiSijaintiAbc = 	Ruutu.valittu.getY();	/*pelaajan valitsema uusi sijainti sallitutSiirroista*/;
